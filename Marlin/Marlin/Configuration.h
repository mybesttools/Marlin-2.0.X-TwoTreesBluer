...
#define STRING_CONFIG_H_AUTHOR "(Mike van der Sluis)" // Who made the changes.
...
#define EXTRUDE_MAXLENGTH 450 //@ maybe needed for filament loading
...
#define DEFAULT_EJERK    5.0  // May be used by Linear Advance @lowered to keep extruder from rattling
